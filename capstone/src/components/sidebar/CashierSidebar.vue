  ...
  <aside class="w-64 bg-slate-800 min-h-screen flex flex-col">
    <div class="p-6 border-b border-slate-700">
      <div class="flex items-center gap-3">
        ...
        <div>
          <h2 class="text-white font-semibold text-lg">Cashier Module</h2>
          <p class="text-slate-400 text-xs">Cashier</p>
        </div>
      </div>
    </div>
    ...
    <div class="p-4 border-t border-slate-700">
      <div class="flex items-center gap-3 px-4 py-3">
        ...
        <div class="flex-1">
          <p class="text-white text-sm font-medium">Cashier</p>
          <p class="text-slate-400 text-xs">cashier@aestheticare.com</p>
        </div>
      </div>
